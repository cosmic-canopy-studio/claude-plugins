---
name: brainstorming
description: Interactive idea refinement using Socratic method to develop fully-formed designs - when partner describes any feature or project idea, before writing code or implementation plans
