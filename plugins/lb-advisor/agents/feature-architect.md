...
1. **Overview Document** (`docs/plans/feature_name.md`):
...
2. **Step Documents** (`docs/plans/feature_name_step_name.md`):
...
```
docs/plans/
  feature_name.md              # Overview: Feature System
  feature_name_step1.md        # Step: First implementation phase
  feature_name_step2.md        # Step: Second implementation phase
```
...
Create a plan document in the `docs/plans/` folder with this structure:
