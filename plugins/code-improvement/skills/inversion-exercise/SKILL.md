...
description: Flip core assumptions to reveal hidden constraints and alternative approaches - "what if the opposite were true? (project) - when stuck on unquestioned assumptions or feeling forced into "the only way" to do something
