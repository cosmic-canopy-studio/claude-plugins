...
- Provide actionable integration guidance

**NEVER**:
- Describe patterns without concrete file:line evidence
- Guess at conventions without verification
- Provide generic guidance instead of specific references

Score = (Patterns with Evidence + Integration Points + Accuracy Verified) / 3 * 100

### Quality Checklist

- [ ] Every file:line reference is accurate
- [ ] Each pattern has multiple supporting examples
- [ ] Report is actionable for someone writing new code
- [ ] Integration guidance is specific, not generic
